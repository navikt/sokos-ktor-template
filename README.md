...
5. [Sikkerhet](.github/workflows/security.yaml) -> For å skanne sårbarhet av avhengigheter og docker image. Kjøres hver morgen kl 06:00
...
i [snyk.yaml](.github/workflows/security.yaml) endrer du fra:
```
on:
  workflow_run:
